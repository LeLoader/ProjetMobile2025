...
public class WordObject : WordBase
{
    ...
    private bool IsTouchingTop()
    {
        ...
        Debug.DrawLine(transform.position + new Vector3(-coll.bounds.size.x / 2 + coll.bounds.size.x / 10, 0, 0), transform.position + new Vector3(-coll.bounds.size.x / 2 + coll.bounds.size.x / 10, 0, 0) + Vector3.up * ((coll.bounds.size.y / 2) + distanceCheck), Color.magenta);
        Debug.DrawLine(transform.position + new Vector3(coll.bounds.size.x / 2 - coll.bounds.size.x / 10, 0, 0), transform.position + new Vector3(coll.bounds.size.x / 2 - coll.bounds.size.x / 10, 0, 0) + Vector3.up * ((coll.bounds.size.y / 2) + distanceCheck), Color.blue);
        ...
        RaycastHit2D hit2 = Physics2D.Raycast(transform.position + new Vector3(-coll.bounds.size.x / 2 + coll.bounds.size.x / 10, 0, 0)  , Vector2.up, (coll.bounds.size.y / 2) + distanceCheck, (int)Mathf.Pow(2, MAP_LAYERMASK));
        RaycastHit2D hit3 = Physics2D.Raycast(transform.position + new Vector3(coll.bounds.size.x / 2 - coll.bounds.size.x / 10, 0, 0), Vector2.up, (coll.bounds.size.y / 2) + distanceCheck, (int)Mathf.Pow(2, MAP_LAYERMASK));
